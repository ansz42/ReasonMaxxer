...
- Full-split 1.5B pack: `unsloth/Qwen2.5-1.5B-Instruct` on **all 500** MATH-500 items, LoRA r=64 / α=128 on q/k/o/v/up/down/gate (`offline_search/configs/test_pack_qwen25_1p5b.yaml`)
- Preferred train knobs (from the MATH-500 retry): lr **`2e-5`**, batch **2×4**, **`max_grad_norm` 0.1**
